...
namespace Formulaire
{
    public partial class Form1 : Form
    {
        ...
        private void ModifierButton_Click(object sender, EventArgs e)
        {
            ...
            cnx.Open();
            SqlCommand cmd = new SqlCommand("Update livre set  Prix= @Prix where Titre =@Titre", cnx);
        ...
        private void SupprimerButton_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection cnx = new SqlConnection("Data Source=DESKTOP-43NSE72\\SQLEXPRESS;Initial Catalog=Livre1;Integrated Security=True");
            cnx.Open();
            SqlCommand cmd = new SqlCommand("Delete livre where Titre =@Titre", cnx);
            cmd.Parameters.AddWithValue("@Titre", titretext.Text);
            cmd.Parameters.AddWithValue("@Prix", int.Parse(prixtext.Text));
            cmd.ExecuteNonQuery();
            cnx.Close();
        ...
        private void ConfirmeButton_Click(object sender, EventArgs e)
        {
            SqlConnection cnx = new SqlConnection("Data Source=DESKTOP-43NSE72\\SQLEXPRESS;Initial Catalog=Livre1;Integrated Security=True");
            cnx.Open();
            SqlCommand cmd = new SqlCommand("insert into livre values (@Titre,@Prix)", cnx);
            cmd.Parameters.AddWithValue("@Titre", titretext.Text);
            cmd.Parameters.AddWithValue("@Prix", int.Parse(prixtext.Text));
            cmd.ExecuteNonQuery();
        ...
        private void comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            SqlConnection cnx = new SqlConnection("Data Source=DESKTOP-43NSE72\\SQLEXPRESS;Initial Catalog=Livre1;Integrated Security=True");
            cnx.Open();
            SqlCommand cmd = new SqlCommand("Select * from livre where Titre ='" + comboBox.Text+ "'",cnx);
            cmd.ExecuteNonQuery();
